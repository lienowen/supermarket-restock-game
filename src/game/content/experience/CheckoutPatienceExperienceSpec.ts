...
export const CHECKOUT_PATIENCE_EXPERIENCE_SPECS: readonly CheckoutPatienceExperienceSpec[] = Object.freeze([
  Object.freeze({
    ...
    customerCount: 8,
    patienceDurationMs: 28000,
    wrongWeightPenaltyMs: 3000,
    customerProfiles: Object.freeze([
      Object.freeze({ type: "regular" as const, itemCount: 2, patienceDurationMs: 28000, mistakePenaltyMultiplier: 1 }),
      Object.freeze({ type: "rushed" as const, itemCount: 2, patienceDurationMs: 24000, mistakePenaltyMultiplier: 1.5 }),
      Object.freeze({ type: "large-order" as const, itemCount: 4, patienceDurationMs: 36000, mistakePenaltyMultiplier: 1 }),
      Object.freeze({ type: "regular" as const, itemCount: 2, patienceDurationMs: 28000, mistakePenaltyMultiplier: 1 }),
      Object.freeze({ type: "rushed" as const, itemCount: 2, patienceDurationMs: 24000, mistakePenaltyMultiplier: 1.5 }),
      Object.freeze({ type: "large-order" as const, itemCount: 5, patienceDurationMs: 42000, mistakePenaltyMultiplier: 1 }),
      Object.freeze({ type: "regular" as const, itemCount: 3, patienceDurationMs: 30000, mistakePenaltyMultiplier: 1 }),
      Object.freeze({ type: "rushed" as const, itemCount: 3, patienceDurationMs: 24000, mistakePenaltyMultiplier: 1.5 })
    ]),
