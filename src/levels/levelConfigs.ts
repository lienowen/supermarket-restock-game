...
export const LEVELS: Record<LevelId, LevelConfig> = {
  ...
  day09: { id: "day09", title: "Priority Order", objective: "Fulfill an urgent customer order: pick apple, cereal and milk, deliver them to the priority shelf before time runs out.", zones: ["backroom", "salesfloor", "priority"], shiftSeconds: 180, salesTargets: { openToRush: 1, rushToClosing: 3 }, customerIntervalsMs: { open: 5000, rush: 3500 }, customerMix: { priority: 1 }, features: { ...baseFeatures, customerWaiting: true, customerQuestions: true, rushHour: true, shelfCorrection: true } }
};
