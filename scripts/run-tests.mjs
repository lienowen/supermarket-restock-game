...
const run = spawnSync(
  ...
  [
    ...
    "tests/l8-closing-safety-acceptance.test.cjs",
    "tests/checkout-patience-experience.test.cjs",
    ...
    "tests/v3-cooler-stock-layout.test.cjs",
    ...
    "tests/cleaning-architecture-boundaries.test.cjs",
